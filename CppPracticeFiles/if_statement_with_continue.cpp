...
int main(){
    ...
    for (int i = 1 ;i <= 10; i++) // AMOUNT OF ROW AND LENGTH OF COLUMN
    {
        ...
        continue; 
        // Everything after the continue wont be executed but loop wont stop here
        //break; 
        // Break operation commented for this program. Comment out continue to make break functional
